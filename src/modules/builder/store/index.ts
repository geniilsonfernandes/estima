...
interface IBuilderState {
  ...
  updateCompany: (company: Partial<IBuilderState['company']>) => void;
  updateCustomer: (customer: Partial<IBuilderState['customer']>) => void;
  updateBudgedInfo: (info: Partial<IBuilderState['budgedInfo']>) => void;
